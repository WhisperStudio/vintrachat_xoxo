...
import { languageLabels, useLanguage, type Language } from '@/context/LanguageContext'
...
const headerCopy: Record<Language, {
  nav: {
    websites: string
    chatWidget: string
    invitations: string
    ...
    <StyledHeader $scrolled={isScrolled}>
      <HeaderFrame>
        <HeaderInner>
          ...
          <RightSide>
            <ActionRow>
              <LanguageSwitch aria-label={text.actions.language}>
